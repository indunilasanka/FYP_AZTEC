  ...
  private _data = [
    {
      ...
      text: '"Vader and Me"',
      preview: 'app/requests/vader-and-me-preview.png',
      ...
      preview: 'app/requests/my-little-kitten.png',
      ...
      text: '"New York, USA"',
      preview: 'app/requests/new-york-location.png',
      ...
      header: 'Posted photo',
      text: '"Protein Heroes"',
      preview: 'app/requests/genom.png',
